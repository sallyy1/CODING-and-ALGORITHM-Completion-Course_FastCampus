...
var_func = mul_10 # mul_10() 함수는 사용은 아직 안했지만, 객체로 생성되어 메모리에 할당되어 있음
print(var_func)
print(type(var_func)) # 클래스 형태로 선언되어 있음
...
func_final(10, 10, lambda_mul_10) # func 인자에 이전에 만들어 놓았던 lambda 함수 활용 가능
